...
Thank you for using **Oblivion Kernel** — an open-source kernel written in Rust, developed and maintained by [Sky Genesis Enterprise](https://skygenesisenterprise.com).
...
- 💬 [GitHub Discussions](https://github.com/OblivionOS/kernel/discussions)
- 🐞 [GitHub Issues](https://github.com/OblivionOS/kernel/issues) – for bug reports only
